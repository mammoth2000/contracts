...
contract RedeemData is Whitelist, Adminable {
    ...
    function peekJob()
        public
        view
        returns (bool active, uint256 jobId, uint256 amount)
    {}
    ...
    function position(
        address _user
    ) public view returns (uint256 first, uint256 pos, uint256 wait) {}
    ...
    function dequeueJob()
        public
        returns (uint256 jobId, address user, uint256 amount)
    {}
}
